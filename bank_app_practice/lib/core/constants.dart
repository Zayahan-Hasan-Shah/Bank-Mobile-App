...
const noInternetMessage = 'No Internet Connection Available.';
...
/// on boarding text
const eft = 'Easy, Fast & Trusted';
const sym = 'Save Your Money';
const ft = 'Free Transactions';
const it = 'International\n Transactions';
